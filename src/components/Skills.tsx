...
import { GitMerge, Settings, Monitor, Cpu, Network } from 'lucide-react';
...
const icons = {
  ...
  Karma: <svg viewBox="0 0 32 32" width={S} height={S}><rect width="32" height="32" rx="5" fill="#001a18"/><path d="M16 7l2.5 5 5.5.8-4 3.9.9 5.5-4.9-2.6-4.9 2.6.9-5.5-4-3.9 5.5-.8z" fill="none" stroke="#56c3a5" strokeWidth="1.4" strokeLinejoin="round"/></svg>,
...
const categories: { label: string; accent: string; skills: SkillItem[] }[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Karma', color: '#56c3a5', bg: 'rgba(86,195,165,0.07)', border: 'rgba(86,195,165,0.18)', icon: icons.Karma },
    ],
  },
  {
    label: 'Tools & DevOps',
